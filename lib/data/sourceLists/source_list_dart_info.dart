...
class SourceListDartInfo {
  static final List<CustomCard> sourceListDartInfo = [
    const CustomCard(title: Strings.dartInfoTitleHistory, source: "https://en.wikipedia.org/wiki/Dart_(programming_language)"),
    const CustomCard(title: Strings.dartInfoTitleNative, source: "https://dart.dev/overview"),
    ...
    const CustomCard(
        title: Strings.dartInfoTitleNullSafety, subtitle: Strings.dartInfoSubtitleNullSafety, source: "https://dart.dev/null-safety"),
    const CustomCard(
        title: Strings.dartInfoTitleVersatility, subtitle: Strings.dartInfoSubtitleVersatility, source: "https://dart.dev/language"),
  ];
}
